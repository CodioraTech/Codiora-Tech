...
const MASTER_TECH_DATA = [
    ...
    { name: "Prisma", logo: "https://cdn.simpleicons.org/prisma/0f172a" },
    ...
    { name: "CircleCI", logo: "https://cdn.simpleicons.org/circleci/0f172a" },
    ...
    { name: "JWT", logo: "https://cdn.simpleicons.org/jsonwebtokens/0f172a" },
    { name: "OAuth2", logo: "https://cdn.simpleicons.org/auth0/0f172a" },

    // --- SPECIAL FIXES ---
    { name: "REST", logo: "https://cdn.simpleicons.org/postman/FF6C37" },
    { name: "Service Workers", logo: "https://cdn.simpleicons.org/pwa/5A0FC8" },
    { name: "gRPC", logo: "https://cdn.simpleicons.org/grpc/0f172a" },
    ...
    { name: "Expo", logo: "https://cdn.simpleicons.org/expo/0f172a" },
    ...
    { name: "CoreData", logo: "https://cdn.simpleicons.org/apple/0f172a" },
    { name: "ARKit", logo: "https://cdn.simpleicons.org/apple/0f172a" },
    { name: "Coroutines", logo: "https://cdn.simpleicons.org/kotlin/7F52FF" },
    { name: "Retrofit", logo: "https://cdn.simpleicons.org/square/0f172a" },
    ...
    { name: "OpenAI API", logo: "data:image/svg+xml;utf8," + encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#0f172a"><path d="M22.2819 9.8211a5.9847 5.9847 0 0 0-.5157-4.9108 6.0462 6.0462 0 0 0-6.5098-2.9A6.0651 6.0651 0 0 0 4.9807 4.1818a5.9847 5.9847 0 0 0-3.9977 2.9 6.0462 6.0462 0 0 0 .7427 7.0966 5.98 5.98 0 0 0 .511 4.9107 6.051 6.051 0 0 0 6.5146 2.9001A5.9847 5.9847 0 0 0 13.2599 24a6.0557 6.0557 0 0 0 5.7718-4.2058 5.9894 5.9894 0 0 0 3.9977-2.9001 6.0557 6.0557 0 0 0-.7475-7.0729zm-9.022 12.6081a4.4755 4.4755 0 0 1-2.8764-1.0408l.1419-.0804 4.7783-2.7582a.7948.7948 0 0 0 .3927-.6813v-6.7369l2.02 1.1686a.071.071 0 0 1 .038.052v5.5826a4.504 4.504 0 0 1-4.4945 4.4944zm-9.6607-4.1254a4.4708 4.4708 0 0 1-.5346-3.0137l.142.0852 4.783 2.7582a.7712.7712 0 0 0 .7806 0l5.8428-3.3685v2.3324a.0804.0804 0 0 1-.0332.0615L9.74 19.9502a4.4992 4.4992 0 0 1-6.1408-1.6464zM2.3408 7.8956a4.485 4.485 0 0 1 2.3655-1.9728V11.6a.7664.7664 0 0 0 .3879.6765l5.8144 3.3543-2.0201 1.1685a.0757.0757 0 0 1-.071 0l-4.8303-2.7865A4.504 4.504 0 0 1 2.3408 7.872zm16.5963 3.8558L13.1038 8.364 15.1192 7.2a.0757.0757 0 0 1 .071 0l4.8303 2.7913a4.4944 4.4944 0 0 1-.6765 8.1042v-5.6772a.79.79 0 0 0-.407-.667zm2.0107-3.0231l-.142-.0852-4.7735-2.7818a.7759.7759 0 0 0-.7854 0L9.409 9.2297V6.8974a.0662.0662 0 0 1 .0284-.0615l4.8303-2.7866a4.4992 4.4992 0 0 1 6.6802 4.66zM8.3065 12.863l-2.02-1.1638a.0804.0804 0 0 1-.038-.0567V6.0742a4.4992 4.4992 0 0 1 7.3757-3.4537l-.142.0805L8.704 5.459a.7948.7948 0 0 0-.3927.6813zm1.0976-2.3654l2.602-1.4998 2.6069 1.4998v2.9994l-2.5974 1.4997-2.6067-1.4997Z"/></svg>') },
    ...
    { name: "Wit.ai", logo: "data:image/svg+xml;utf8," + encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 800" width="800" height="800"><path d="M210 210h380v380H210z" fill="#0f172a"/></svg>'), invert: true }, // Verified box from reading 5661 and 5604 snippet

    // --- DESIGN & GROWTH ---
    { name: "Figma", logo: "https://cdn.simpleicons.org/figma/F24E1E" },
    { name: "Framer", logo: "https://cdn.simpleicons.org/framer/0f172a" },
    { name: "Three.js", logo: "https://cdn.simpleicons.org/threedotjs/0f172a" },
    ...
    { name: "Schema.org", logo: "data:image/svg+xml;utf8," + encodeURIComponent('<svg viewBox="0 0 400 100" xmlns="http://www.w3.org/2000/svg"><text x="10" y="70" font-family="Arial" font-weight="bold" font-size="60" fill="#0f172a">schema.org</text></svg>'), invert: true },
    { name: "Screaming Frog", logo: "data:image/svg+xml;utf8," + encodeURIComponent('<svg width="256" height="256" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg"><rect width="256" height="256" rx="40" fill="#75b53a"/><path d="M128 64c-35 0-64 29-64 64s29 64 64 64 64-29 64-64-29-64-64-64zm0 110c-25 0-46-21-46-46s21-46 46-46 46 21 46 46-21 46-46 46z" fill="#0f172a"/></svg>') },
    { name: "Moz", logo: "data:image/svg+xml;utf8," + encodeURIComponent('<svg viewBox="0 0 100 40" xmlns="http://www.w3.org/2000/svg"><text x="5" y="32" font-family="Arial" font-weight="bold" font-size="30" fill="#0f172a">MOZ</text></svg>'), invert: true },
    { name: "Crazy Egg", logo: "data:image/svg+xml;utf8," + encodeURIComponent('<svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg"><path d="M24 8C15 8 8 15 8 24s7 16 16 16 16-7 16-16S33 8 24 8zm0 28c-6.6 0-12-5.4-12-12s5.4-12 12-12 12 5.4 12 12-5.4 12-12 12z" fill="#0f172a"/></svg>'), invert: true },
    { name: "VWO", logo: "data:image/svg+xml;utf8," + encodeURIComponent('<svg viewBox="0 0 100 50" xmlns="http://www.w3.org/2000/svg"><text x="10" y="35" font-family="Arial" font-weight="bold" font-size="30" fill="#0f172a">VWO</text></svg>'), invert: true },
    { name: "Unbounce", logo: "data:image/svg+xml;utf8," + encodeURIComponent('<svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg"><path d="M24 6c-10 0-18 8-18 18s8 18 18 18 18-8 18-18S34 6 24 6zm0 32c-7.7 0-14-6.3-14-14S16.3 10 24 10s14 6.3 14 14-6.3 14-14 14z" fill="#0f172a"/></svg>'), invert: true },
    { name: "Optimizely", logo: "data:image/svg+xml;utf8," + encodeURIComponent('<svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg"><path d="M24 4C12.9 4 4 12.9 4 24s8.9 20 20 20 20-8.9 20-20S35.1 4 24 4zm0 36c-8.8 0-16-7.2-16-16s7.2-16 16-16 16 7.2 16 16-7.2 16-16 16z" fill="#0f172a"/></svg>'), invert: true },
    { name: "Google Optimize", logo: "data:image/svg+xml;utf8," + encodeURIComponent('<svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg"><path d="M24 4C13 4 4 13 4 24s9 20 20 20 20-9 20-20S35 4 24 4zm0 36c-8.8 0-16-7.2-16-16s7.2-16 16-16 16 7.2 16 16-7.2 16-16 16z" fill="#0f172a"/></svg>'), invert: true },
    ...
    { name: "Marvel", logo: "https://cdn.simpleicons.org/marvelapp/0f172a" },
...
export default function TechMarquee({ technologies = [] }) {
    ...
    return (
        <section className="relative w-full overflow-hidden bg-white py-10">
            {/* Gradient Overlays */}
            <div className="absolute top-0 left-0 h-full w-20 md:w-32 bg-gradient-to-r from-white to-transparent z-10 pointer-events-none" />
            <div className="absolute top-0 right-0 h-full w-20 md:w-32 bg-gradient-to-l from-white to-transparent z-10 pointer-events-none" />
...
function TechCard({ tech }) {
    return (
        <div className="
            ...
            bg-[#f8fafc] border border-[#122a46]/10 rounded-full 
            backdrop-blur-sm hover:bg-[#122a46]/5 hover:border-[#122a46]/20 transition-all shadow-sm
            whitespace-nowrap shrink-0
        ">
            <div className={`w-5 h-5 md:w-6 md:h-6 flex items-center justify-center ${tech.invert ? 'filter brightness-0' : ''}`}>
                <img
                    src={tech.logo}
                    alt={tech.name}
