...
export default function LeadMagnet() {
    ...
    return (
        <section className="py-24 relative overflow-hidden bg-[#f8fafc] text-[#122a46]">
            {/* Background Ambience */}
            <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-teal-500/10 rounded-full blur-[120px] pointer-events-none animate-pulse-slow" />
            <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-[#122a46]/5 rounded-full blur-[120px] pointer-events-none animate-pulse-slow delay-1000" />
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                >
                    ...
                    <div className="relative bg-white border border-[#122a46]/10 p-6 md:p-16 rounded-[2rem] md:rounded-[2.5rem] overflow-hidden w-full max-w-full">
                        {/* Subtle inner gloss */}
                        ...
                        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center relative z-10">
                            <div>
                                <motion.span
                                    ...
                                    className="inline-block py-1 px-3 rounded-full bg-teal-500/10 border border-teal-500/20 text-teal-600 text-xs font-bold tracking-widest uppercase mb-6"
                                >
                                    Exclusive Resource
                                </motion.span>
                                <motion.h2
                            ...
                            <div className="bg-[#122a46]/5 border border-[#122a46]/5 p-8 rounded-3xl backdrop-blur-sm relative">
                                    ...
                                    {status === 'success' ? (
                                        ...
                                        >
                                            <div className="w-20 h-20 bg-green-500 rounded-full flex items-center justify-center mx-auto mb-6 shadow-[0_0_30px_rgba(34,197,94,0.5)]">
                                                <svg className="w-10 h-10 text-[#122a46]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" /></svg>
                                            </div>
                                            <h3 className="text-2xl font-bold text-[#122a46] mb-2">Check Your Inbox!</h3>
                                            <p className="text-slate-500">The guide is on its way to {email}.</p>
                                        </motion.div>
                                    ) : (
                                        <motion.form
                                            initial={{ opacity: 0 }}
                                        ...
                                        >
                                            <div className="space-y-2">
                                                ...
                                                <input
                                                    ...
                                                    required
                                                    className="w-full bg-[#f8fafc]/40 border border-[#122a46]/10 rounded-xl px-5 py-4 text-[#122a46] focus:border-teal-500 focus:ring-1 focus:ring-cyan-500 transition-all outline-none placeholder:text-gray-700 font-medium"
                                            ...
                                            <motion.button
                                                ...
                                                whileTap={{ scale: 0.98 }}
                                                className="w-full py-5 rounded-xl bg-gradient-to-r from-cyan-600 to-purple-600 text-[#122a46] font-bold text-lg tracking-wide shadow-lg shadow-cyan-500/20 hover:shadow-cyan-500/40 transition-all group relative overflow-hidden"
                                            >
                                                ...
                                                <div className="absolute inset-0 bg-[#122a46]/20 translate-y-full group-hover:translate-y-0 transition-transform duration-300" />
                                            </motion.button>
