...
export default function PrivacyPolicy() {
    return (
        <>
            ...
            <div className="bg-[#f8fafc] min-h-screen text-slate-600 font-sans selection:bg-blue-500/30 overflow-hidden relative">
                ...
                <div className="container mx-auto px-6 py-44 max-w-4xl relative z-10">
                    ...
                    >
                        <motion.div
                            ...
                            className="inline-block px-4 py-1 rounded-full bg-[#122a46]/5 border border-[#122a46]/10 text-blue-400 text-xs font-bold uppercase tracking-widest mb-6"
                        >
                            Legal Compliance
                        </motion.div>
                    ...
                    <div className="space-y-16">
                        ...
                        >
                            ...
                            <p className="text-slate-500 mb-8">We may collect, use, store and transfer different kinds of personal data about you which we have grouped together as follows:</p>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                {[
                                    ...
                                    <div key={i} className="bg-[#122a46]/5 border border-[#122a46]/5 p-6 rounded-2xl hover:bg-[#122a46]/10 transition-colors group">
                                        <div className="flex items-center gap-4 mb-3">
                                            ...
                                            <h3 className="text-[#122a46] font-bold">{item.title}</h3>
                                        </div>
                        ...
                        >
                            ...
                            <div className="bg-[#122a46]/5 border border-[#122a46]/5 rounded-2xl p-6 md:p-8">
                                <p className="mb-4 text-slate-500">We will only use your personal data when the law allows us to. Most commonly, we will use your personal data in the following circumstances:</p>
                        ...
                        >
                            ...
                            <p className="text-lg leading-relaxed text-slate-500 mb-4">
                            ...
                            <p className="text-lg leading-relaxed text-slate-500 border-l-2 border-blue-500/50 pl-4 py-1 bg-blue-500/5 rounded-r-lg">
                        ...
                        >
                            ...
                            <p className="text-slate-500 mb-6">If you have any questions about this privacy policy or our privacy practices, please contact us at:</p>

                            <div className="bg-gradient-to-br from-[#0a0a0a] to-[#111] p-8 rounded-3xl border border-[#122a46]/10 relative overflow-hidden group max-w-lg">
                                ...
                                <div className="relative z-10">
                                    <h3 className="text-[#122a46] font-bold text-xl mb-4 flex items-center gap-2">
                                    ...
                                    <div className="space-y-3 text-slate-500 font-medium">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <a href="mailto:contact@codioratech.com" className="hover:text-[#122a46] transition-colors">contact@codioratech.com</a>
                                        </div>
                                        <div className="flex items-center gap-3">
