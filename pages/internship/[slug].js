...
const positionData = {
    "frontend-engineering": {
        ...
        description: `
            ...
            <h3 class="text-[#122a46] font-bold text-xl mt-8 mb-4">What You Will Learn</h3>
        ...
        <>
            ...
            <div className="bg-[#f8fafc] min-h-screen text-slate-600 selection:bg-teal-500/30 font-sans">
                ...
                <div className="container mx-auto px-6 pt-32 pb-40 relative z-10 max-w-4xl">
                    <Link href="/internship" className="inline-flex items-center gap-2 text-sm text-slate-500 hover:text-[#122a46] transition-colors mb-12 uppercase tracking-widest font-bold">
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 19l-7-7 7-7"></path></svg>
                        Back to Tracks
                    </Link>

                    <div className="bg-white border border-[#122a46]/5 p-10 md:p-16 rounded-[2.5rem] relative overflow-hidden">
                        ...
                        <div className="prose prose-invert prose-lg max-w-none text-slate-500 leading-relaxed mb-12">
                            <div dangerouslySetInnerHTML={{ __html: post.description }}></div>
                        </div>

                        <div className="border-t border-[#122a46]/10 pt-10 flex flex-col md:flex-row items-center justify-between gap-6">
                            <div>
                                <div className="text-[#122a46] font-bold mb-1">Fall 2025 Cohort</div>
