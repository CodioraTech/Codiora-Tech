...
export default function History() {
    return (
        <>
            ...
            <section className="min-h-screen bg-[#f8fafc] text-[#122a46] pt-32 pb-20 relative overflow-hidden">
                <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-teal-500/10 rounded-full blur-[150px] pointer-events-none" />
                ...
                <div className="container mx-auto px-6 relative z-10">
                    ...
                    >
                        ...
                        <p className="text-xl text-slate-500">From a dorm room idea to a global digital powerhouse.</p>
                    </motion.div>

                    <div className="max-w-4xl mx-auto border-l-2 border-[#122a46]/10 ml-4 md:ml-auto pl-8 md:pl-0 space-y-16">
                        {[
                            ...
                            >
                                {/* Dot */}
                                <div className="absolute -left-[41px] md:left-auto md:right-1/2 md:-mr-[5px] w-5 h-5 bg-[#f8fafc] border-4 border-gray-600 rounded-full group-hover:border-teal-500 group-hover:scale-125 transition-all z-10"></div>

                                <div className={`md:w-1/2 ${i % 2 === 0 ? 'md:text-right md:pr-16 text-left' : 'md:order-last md:pl-16 md:text-left'} mb-4 md:mb-0`}>
                                    <span className="text-6xl font-black text-[#122a46]/5 absolute -top-4 -z-10 select-none group-hover:text-[#122a46]/10 transition-colors">{item.year}</span>
