...
export default function Skills() {
    ...
    return (
        <div className="bg-[#020202] text-white min-h-screen selection:bg-purple-500/30 selection:text-white overflow-hidden">
            <Head>
            ...
            <section className="relative pt-40 pb-20 overflow-hidden">
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[600px] bg-purple-600/10 rounded-full blur-[150px] pointer-events-none" />
                    ...
                    >
                        {skillCategories.map((category, index) => (
                            <motion.div
                                ...
                                key={index}
                                className="group relative p-8 bg-[#0a0a0a] rounded-3xl border border-white/5 hover:border-cyan-500/30 transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_10px_40px_rgba(0,0,0,0.5)] bg-gradient-to-b from-white/[0.02] to-transparent overflow-hidden"
                            >
                                <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/5 to-purple-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />

                                <div className="relative z-10">
                                    <div className="w-12 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-2xl mb-6 group-hover:scale-110 group-hover:border-cyan-500/50 group-hover:text-cyan-400 transition-all duration-300">
                                        {category.icon}
                                    </div>
                                    ...
                                    <ul className="space-y-3">
                                        {category.skills.map((skill, i) => (
                                            <li key={i} className="flex items-center text-sm text-gray-400 group-hover:text-gray-300 transition-colors">
                                                <span className="w-1.5 h-1.5 rounded-full bg-purple-500 mr-3 group-hover:bg-cyan-400 transition-colors" />
                                                {skill}
                                            </li>
                                        ))}
                                    </ul>
            ...
            {/* Bottom CTA */}
            <section className="py-24 relative overflow-hidden bg-white/[0.02] border-t border-white/5">
                <div className="container mx-auto px-6 max-w-5xl">
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div>
                            <h2 className="text-4xl md:text-5xl font-bold mb-6">
                                Let's redefine what's <span className="text-white">possible</span> together.
                            </h2>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 pt-4">
                                <a href="/contact" className="group relative inline-flex items-center justify-center px-8 py-4 font-bold text-white transition-all duration-300 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-full hover:scale-105 hover:shadow-[0_0_30px_rgba(6,182,212,0.4)] overflow-hidden">
                                    <span className="absolute inset-0 bg-white/20 translate-y-full group-hover:translate-y-0 transition-transform duration-300 backdrop-blur-sm"></span>
                                    <span className="relative flex items-center gap-3">
                                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path></svg>
                                        Book a Call
                                    </span>
                                </a>
                                <a href="mailto:hello@codioratech.com" className="group inline-flex items-center justify-center px-8 py-4 font-bold text-white transition-all duration-300 border border-white/10 rounded-full hover:bg-white/5 hover:border-cyan-400/50 hover:text-cyan-400">
                            ...
                            <form className="space-y-4">
                                <div className="space-y-4">
                                    <input
                                        ...
                                        className="w-full bg-[#0a0a0a] border border-white/10 rounded-xl px-6 py-4 text-white placeholder-gray-500 focus:outline-none focus:border-purple-500/50 transition-colors"
                                    />
                                    <input
                                        type="tel"
                                    ...
                                    <textarea
                                        ...
                                        className="w-full bg-[#0a0a0a] border border-white/10 rounded-xl px-6 py-4 text-white placeholder-gray-500 focus:outline-none focus:border-purple-500/50 transition-colors resize-none"
                                    ></textarea>
                                </div>
                                ...
                                <button type="submit" className="w-full group relative overflow-hidden rounded-xl bg-[#0a0a0a] border border-white/10 px-8 py-4 font-bold text-white transition-all hover:border-purple-500/50 mt-4 text-left flex justify-between items-center shadow-[0_0_20px_rgba(168,85,247,0.1)] hover:shadow-[0_0_30px_rgba(168,85,247,0.2)]">
