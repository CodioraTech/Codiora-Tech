                        ...
                        <div className="flex flex-col gap-8">
                            ...
                            >
                                <div className="bg-[#0a0a0a] border border-white/5 p-8 rounded-3xl hover:border-white/10 transition-colors group">
                                    ...
                                    <a href="mailto:contact@codioratech.com" className="text-white font-bold text-lg hover:text-cyan-400 transition-colors">contact@codioratech.com</a>
                                </div>
                                ...
                                <div className="bg-[#0a0a0a] border border-white/5 p-8 rounded-3xl hover:border-white/10 transition-colors group">
                                    ...
                                    <a href="tel:+8809611317892" className="text-white font-bold text-lg hover:text-purple-400 transition-colors">+880 9611 317 892</a>
                                </div>
                                ...
                                <div className="bg-[#0a0a0a] border border-white/5 p-8 rounded-3xl hover:border-white/10 transition-colors group">
                                    ...
                                    <a href="https://wa.me/8801772445954" target="_blank" rel="noopener noreferrer" className="text-white font-bold text-lg hover:text-green-400 transition-colors">+880 1772-445954</a>
                                </div>

                                <div className="bg-[#0a0a0a] border border-white/5 p-8 rounded-3xl hover:border-white/10 transition-colors group">
                                    <div className="w-12 h-12 bg-white/5 rounded-full flex items-center justify-center mb-6 group-hover:bg-red-500/10 transition-colors">
