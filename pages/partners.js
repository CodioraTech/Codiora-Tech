            ...
            <div className="bg-[#020202] min-h-screen text-white overflow-hidden selection:bg-purple-500/30">
                ...
                <div className="container mx-auto px-6 pt-32 pb-20 relative z-10">
                    <div className="text-center mb-20">
                        <motion.div initial={{ opacity: 0, scale: 0.5 }} animate={{ opacity: 1, scale: 1 }} className="inline-block mb-4 px-4 py-1.5 rounded-full border border-purple-500/30 bg-purple-500/10 text-purple-400 text-xs font-bold uppercase tracking-widest backdrop-blur-sm">
                            Get Connected
                        </motion.div>
                        <motion.h1
                    ...
                    >
                        <div className="relative bg-white/5 backdrop-blur-2xl border border-white/10 p-12 md:p-16 rounded-[2.5rem] overflow-hidden group text-center shadow-2xl">
                            {/* Glossy sheen */}
                            <div className="absolute top-0 right-0 w-full h-full bg-gradient-to-b from-white/5 to-transparent pointer-events-none" />
                            <div className="absolute -top-20 -right-20 w-60 h-60 bg-purple-500/20 rounded-full blur-[80px] group-hover:bg-purple-500/30 transition-colors" />
                            ...
                            <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">Become A Strategic Partner</h2>
                            ...
                            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center relative z-10">
                                ...
                                <Link href="/partner-program">
                                    <button className="w-full sm:w-auto px-10 py-4 border border-white/30 text-white font-bold text-lg rounded-full hover:bg-white/10 hover:border-white transition-all backdrop-blur-sm">
