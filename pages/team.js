            ...
            <div className="bg-[#f8fafc] min-h-screen text-[#122a46] overflow-hidden selection:bg-teal-500/10">
                ...
                <div className="container mx-auto px-6 pt-44 pb-40 relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {teamMembers.map((member, i) => (
                            ...
                            >
                                ...
                                <div className="relative bg-white border border-[#122a46]/5 rounded-3xl overflow-hidden hover:translate-y-[-10px] transition-transform duration-500 flex flex-col h-full shadow-2xl">
                                    <div className="h-[320px] overflow-hidden relative border-b border-[#122a46]/5">
                                    ...
                                    <div className="p-8 flex-1 flex flex-col bg-white relative z-20">
                                        <div className="mb-auto">
                                            <h3 className="text-2xl font-bold text-[#122a46] mb-2">{member.name}</h3>
                                        ...
                                        {/* Micro Stats */}
                                        <div className="grid grid-cols-2 gap-4 border-t border-[#122a46]/5 pt-6 mb-6">
                                            <div>
                                                <div className="text-xl font-bold text-[#122a46]">10+</div>
                                                <div className="text-[10px] uppercase tracking-wider text-gray-600 font-bold">Years Exp.</div>
                                            </div>
                                            <div>
                                                <div className="text-xl font-bold text-[#122a46]">50+</div>
                                        ...
                                        <div className="flex gap-3 mt-auto">
                                            {/* LinkedIn */}
                                            <a href="#" className="w-10 h-10 rounded-full bg-[#122a46]/5 border border-[#122a46]/10 flex items-center justify-center text-slate-500 hover:text-[#122a46] hover:bg-[#0077b5] hover:border-[#0077b5] transition-all duration-300">
                                                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" /></svg>
                                            </a>
                                            {/* X / Twitter */}
                                            <a href="#" className="w-10 h-10 rounded-full bg-[#122a46]/5 border border-[#122a46]/10 flex items-center justify-center text-slate-500 hover:text-[#122a46] hover:bg-[#f8fafc] hover:border-gray-500 transition-all duration-300">
                    ...
                    <div className="mt-40 text-center">
                        <p className="text-slate-500 text-sm uppercase tracking-widest mb-6">We are always scouting for talent</p>
                        <h2 className="text-3xl font-bold text-[#122a46] mb-8">Think you have what it takes?</h2>
