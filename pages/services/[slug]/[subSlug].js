...
export default function SubServicePage({ service, subService, slug }) {
    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-dark text-white pt-24 pb-20 relative overflow-hidden">
                ...
                <div className="container mx-auto px-6 relative z-10">
                    {/* Breadcrumb */}
                    <div className="text-sm text-gray-500 mb-8 font-mono flex items-center flex-wrap gap-2">
                    ...
                    <div className="max-w-5xl mx-auto">
                        ...
                        <motion.section
                            ...
                            viewport={{ once: true }}
                            className="mb-20 glass-panel p-10 rounded-3xl border border-white/5 bg-gradient-to-b from-white/5 to-transparent backdrop-blur-md"
                        >
                        ...
                        >
                            <h2 className="text-3xl font-bold text-center mb-20 text-white">How We Execute</h2>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                                {details.process.map((step, idx) => (
                                    <div key={idx} className="relative group pt-10">
                                        ...
                                        <div className="lg:hidden absolute left-1/2 -top-6 bottom-0 w-0.5 bg-white/10 -translate-x-1/2 z-0"></div>
                                        ...
                                        <div className="relative z-10 flex flex-col items-center">
                                            ...
                                            <div className="relative mb-6">
                                                ...
                                                <div className="w-20 h-20 rounded-full bg-dark border-2 border-accent/30 group-hover:border-accent text-white flex items-center justify-center text-2xl font-black shadow-[0_0_15px_rgba(0,229,255,0.2)] transition-all duration-300 group-hover:scale-110 relative z-10 bg-gradient-to-br from-white/10 to-transparent backdrop-blur-md">
                                            ...
                                            {/* Content Card */}
                                            <div className="w-full bg-white/5 border border-white/5 p-6 rounded-2xl backdrop-blur-sm group-hover:bg-white/10 group-hover:border-accent/20 transition-all duration-300 hover:shadow-2xl hover:shadow-accent/5">
                                                ...
                                                <h3 className="text-xl font-bold text-center mb-3 text-white group-hover:text-accent transition-colors">{step.title}</h3>
                        ...
                        <div className="text-center">
                            <Link href="/contact" className="inline-block px-12 py-5 bg-white text-dark font-bold text-lg rounded-full hover:bg-accent hover:scale-105 transition-all shadow-[0_0_40px_rgba(255,255,255,0.2)]">
